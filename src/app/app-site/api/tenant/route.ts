...
export async function PUT(request: Request) {
  try {
    ...
    const { name, phone, bookingPhone, location, ownerName, themeColor } = body;
    ...
    const updatedTenant = await prisma.tenant.update({
      ...
      data: {
        ...
        phone: phone !== undefined ? phone : existingTenant.phone,
        bookingPhone: bookingPhone !== undefined ? bookingPhone : existingTenant.bookingPhone,
        location: location !== undefined ? location : existingTenant.location,
        ownerName: ownerName !== undefined ? ownerName : existingTenant.ownerName,
        themeColor: themeColor !== undefined ? themeColor : existingTenant.themeColor,
      },
    });
