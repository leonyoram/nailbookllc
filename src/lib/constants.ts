    ...
    return [
      {
        ...
        priceMonthly: "$39",
        priceYearly: "$31",
        desc: "Designed for small salons, private suites, or under 4 techs",
        features: [
          "Custom Branded Booking Website",
          "Manage up to 4 Techs",
          "Collect Deposits to prevent No-Shows",
      ...
      {
        name: "Pro Beauty Studio",
        priceMonthly: "$79",
        priceYearly: "$63",
        desc: "Most popular choice for Nail & Hair Salons with 5 - 12 techs",
        features: [
          "All Starter Features",
          "Manage up to 12 Techs",
          "Unlimited SMS Reminders",
          "Automated Commission & Tip calculation",
          "Auto-send 5-star Google/Yelp Review requests",
          "Auto SMS Marketing for client retention",
        ],
        highlight: true,
        cta: "Start Pro Trial",
      },
      {
        ...
        priceMonthly: "$149",
        priceYearly: "$119",
        desc: "Centralized management solution for Multi-location Salon Chains",
        features: [
          "All Pro Features",
          "Unlimited Techs & Locations",
          "Clover & Square POS Terminal Integration",
          "Polish/Chemical Inventory Management",
          "Onsite Setup & 24/7 Priority Support",
        ],
        highlight: false,
  ...
  return [
    {
      ...
      priceMonthly: "$39",
      priceYearly: "$31",
      desc: "Dành riêng cho tiệm nhỏ, Suite cá nhân hoặc tiệm dưới 4 thợ",
      features: [
        "Trang Web Đặt Lịch Riêng Mang Tên Tiệm",
        "Quản lý tối đa 4 Thợ (Techs)",
        "Thu tiền cọc Deposit chống bùng hẹn",
        "500 Tin nhắn SMS nhắc lịch/tháng",
        "Báo cáo doanh thu ngày/tuần",
      ],
      highlight: false,
    ...
    },
    {
      ...
      priceMonthly: "$79",
      priceYearly: "$63",
      desc: "Lựa chọn phổ biến nhất cho tiệm Nail & Hair Salon từ 5 - 12 thợ",
      features: [
        "Tất cả tính năng gói Starter",
        "Quản lý tối đa 12 Thợ (Techs)",
        "Không giới hạn tin nhắn SMS nhắc lịch",
        "Tự động tính Chia Hoa Hồng (Commission) & Tip",
        "Tự động gửi SMS kéo Review 5 sao Google/Yelp",
        "SMS Marketing tự động nhắc khách cũ quay lại",
      ],
      highlight: true,
      cta: "Bắt Đầu Dùng Thử Gói Pro",
    },
    {
      name: "Enterprise Empire",
      priceMonthly: "$149",
      priceYearly: "$119",
      desc: "Giải pháp quản lý tập trung cho Chuỗi Salon đa chi nhánh",
      features: [
        "Tất cả tính năng gói Pro",
        "Không giới hạn số lượng Thợ & Chi nhánh",
        "Tích hợp Clover, Square POS & Terminal",
        "Quản lý tồn kho Sơn/Hóa chất làm tóc",
        "Hỗ trợ cài đặt Onsite & CSKH ưu tiên 24/7",
      ],
      highlight: false,
      cta: "Liên Hệ Đội Ngũ Sales",
    },
  ];
};
